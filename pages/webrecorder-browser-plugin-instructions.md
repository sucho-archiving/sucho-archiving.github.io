...
When you're ready to record, click the ArchiveWeb.page icon in your browser. You'll see an option *Save To:*; click on the drop-down arrow, then choose *+ New Archiving Session*. Use the name of the website as the name of the archive. In most cases, you should check the "Start with Autopilot" box, which will automatically scroll to the bottom of each page.
...
Once you see at the top of the plugin "**Archiving:** *Idle, Continue Browsing*", click on one of the links on the home page. The auto-pilot will once again scroll down and capture things until you see "**Archiving:** *Idle, Continue Browsing*".
